# KDTREE class extends Evaluator class to evaluate accuracy of
# Term Frequency, Inverse Document Frequency using KD Tree data structure
...
class KDTREE(Evaluator):
    ...
    def vectorize(self):
        """
        Returns vectors of transformed corpus,
        using Bag of Words and Term Frequency/Inverse Document Frequency.
        """
    ...
    def max_similarity(self, q):
        """
        Returns (index, similarity value) of string argument q's most similar match
        in FAQ, determined by nearest neighbor in KDTree of TFIDF vectors.
        """
